            ...
            <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-2 text-slate-500 text-sm mb-4">
                        ...
                        <span>{{ $event->date ? $event->date->format('d M Y, H:i') : '' }}</span>
                    </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            @foreach($partners as $partner)
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-center hover:shadow-md transition">
                    <img src="{{ asset('storage/' . $partner->logo_path) }}" alt="Logo Partner" class="max-w-full max-h-12 object-contain filter grayscale hover:filter-none transition">
                </div>
                @endif
            @endforeach
        </div>
