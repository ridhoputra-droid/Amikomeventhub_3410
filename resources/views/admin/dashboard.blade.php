...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden mb-10">
        <div class="p-8 border-b flex justify-between items-center">
            ...
            <a href="{{ Route::has('admin.transactions') ? route('admin.transactions') : '#' }}" class="text-indigo-600 font-bold hover:underline">Lihat Semua</a>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-8 py-6 text-center text-slate-500">Belum ada transaksi berjalan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center gap-2 text-slate-500 text-sm mb-4">
                            ...
                            <span>{{ is_object($event->date) ? $event->date->format('d M Y, H:i') : $event->date }}</span>
                        </div>
                        <div class="flex justify-between items-center pt-4 border-t">
                            <span class="text-2xl font-black text-indigo-600">Rp {{ number_format($event->price ?? 0, 0, ',', '.') }}</span>
            ...
            @empty
                <div class="col-span-1 md:col-span-2 lg:col-span-3 text-center py-20 bg-white rounded-3xl border border-slate-100">
                    <p class="text-slate-500 text-lg">Belum ada data event di database Anda.</p>
                </div>
            @endforelse
        </div>
    </div>
